...
import ProductsReviews from '@/app/components/productsReviews';
import { cn } from '@/app/lib/ui.shadcn.com/utils'

interface ProductsCardProps extends React.ComponentProps<"div"> {
  product: Product
}

export default function ProductsCard({ product, className, ...props }: ProductsCardProps) {
  ...
  return (
    <div className={cn('flex flex-col w-full', className)} {...props}>
      ...
      <ProductsReviews className='my-4' product={product} />
